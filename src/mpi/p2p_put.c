 ...
 *==============================================================================
 * Test sustained MPI bandwidth using MPI-2 Put/Start-Complete/Post-Wait calls.
 *============================================================================*/
...
int main(int argc, char **argv)
{
    ...
    if( proc == 0 ){
        ...
        sprintf( file1, "put_time-np_%.4d.dat", nprocs );
        sprintf( file2, "put_bw-np_%.4d.dat",   nprocs );
        fp  = fopen( file1, "a" );
        fp2 = fopen( file2, "a" );
