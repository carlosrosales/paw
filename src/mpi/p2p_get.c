 ...
 *==============================================================================
 * Test sustained MPI bandwidth using MPI-2 Get/Start-Complete/Post-Wait calls.
 *============================================================================*/
...
int main(int argc, char **argv)
{
    ...
    if( proc == 0 ){
        ...
        sprintf( file1, "get_time-np_%.4d.dat", nprocs );
        sprintf( file2, "get_bw-np_%.4d.dat",   nprocs );
        fp  = fopen( file1, "a" );
        fp2 = fopen( file2, "a" );
    ...
    if( proc < npairs ){
      MPI_Group_incl( all_task_group, 1, &partner, &group );
    }
    else{
      MPI_Group_incl( all_task_group, 1, &partner, &group );
    }
