 ...
 * the system using a single test size.
 *============================================================================*/
...
int main(int argc, char **argv)
{
    ...
    if( proc == 0 ){
        ...
        sprintf( file1, "multitask_time-np_%.4d.dat", nprocs );
        sprintf( file2, "multitask_bw-np_%.4d.dat",   nprocs );
        fp  = fopen( file1, "a" );
        fp2 = fopen( file2, "a" );
    ...
    // Test if current NLOOP is enough to capture the test cases
    ...
    // Execute test               
    //================================================================
    // Skip warmup, since it was effectively done in the timer test
