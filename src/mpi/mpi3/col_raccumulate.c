 ...
 *==============================================================================
 * Test sustained MPI bandwidth using MPI-3 Raccumulate/Wait.
 *============================================================================*/
...
int main(int argc, char **argv)
{
    ...
    if( proc == 0 ){
        ...
        sprintf( file1, "racc_time-np_%.4d.dat", nprocs );
        sprintf( file2, "racc_bw-np_%.4d.dat",   nprocs );
        fp  = fopen( file1, "a" );
        fp2 = fopen( file2, "a" );
