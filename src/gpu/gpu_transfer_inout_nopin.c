/*==============================================================================
 * Program  : gpu_transfer_inout_nopin
 ...
 * message sizes. In this test memory is not pinned.
 *============================================================================*/
...
{
    FILE   *fp, *fp2;
    char   testName[32] = "GPU_TRANSFER_INOUT_NOPIN";
    ...
    fp  = fopen("gpu_transfer_time_inout_nopin.dat","a");
    fp2 = fopen("gpu_transfer_bw_inout_nopin.dat","a");
