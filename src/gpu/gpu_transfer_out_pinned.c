/*==============================================================================
 * Program  : gpu_transfer_out_pinned
...
{
    FILE   *fp, *fp2;
    char   testName[32] = "GPU_TRANSFER_OUT_PINNED";
    ...
    fp  = fopen("gpu_transfer_time_out_pinned.dat","a");
    fp2 = fopen("gpu_transfer_bw_out_pinned.dat","a");
    ...
    cudaMemcpy( A_d, A, smax * sizeof(float), cudaMemcpyHostToDevice );
