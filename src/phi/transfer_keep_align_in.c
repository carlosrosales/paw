/*==============================================================================
 * Program  : transfer_keep_align_in
...
{
    FILE    *fp, *fp2;
    char    testName[32] = "PHI_TRANSFER_KEEP_AL_IN";
    int     micNum, tid;
    ...
    fp  = fopen( "mic0_keep_al_time_in.dat", "a" );
    fp2 = fopen( "mic0_keep_al_bw_in.dat", "a" );
    ...
    // Open output files and write headers
    fp  = fopen( "mic1_keep_al_time_in.dat", "a" );
    fp2 = fopen( "mic1_keep_al_bw_in.dat", "a" );
    printHeaders( fp, fp2, testName, UsedMem, overhead, threshold_lo );
   ...
   //================================================================
    ...
    // Open output files and write headers
    fp  = fopen( "mic0+1_keep_al_time_in.dat", "a" );
    fp2 = fopen( "mic0+1_keep_al_bw_in.dat", "a" );
    printHeaders( fp, fp2, testName, UsedMem, overhead, threshold_lo );
