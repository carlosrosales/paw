...
\begin{abstract}
The Performance Assessment Workbench (PAW) is an Open Source suite of microbenchmarks designed with simplicity and reliability in mind. This User Guide documents the implementation details and the general usage for all components of PAW. As of version 1.1 the suite contains code designed to test:
...
Version 1.1 is a bug fix release addressing issues in the MPI test \verb+p2p_isend_ping+.
\end{abstract}
