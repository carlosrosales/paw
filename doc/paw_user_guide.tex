...
Version 1.5.1 is a minor update which adds the ability to measure MPI startup times and fixes a bug in the resizing of BLAS tests via environmental variables.
\end{abstract}
